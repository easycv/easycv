...
class Noise(Transform):
    ...
    def apply(self, image, **kwargs):
        if kwargs['method'] == 'gaussian':
            return random_noise(image, mode=kwargs['method'], seed=kwargs['seed'] if kwargs['seed'] else None,
                                clip=kwargs['clip'], mean=kwargs['mean'], var=kwargs['var'])
            ...
            return random_noise(image, mode=kwargs['method'], seed=kwargs['seed'] if kwargs['seed'] else None,
                                amount=kwargs['amount'], salt_vs_pepper=kwargs['salt_vs_pepper'])
